...
export default function ShiftsPage() {
  const [open, setOpen] = useState(false); const [editing, setEditing] = useState<Shift | undefined>(undefined);
  const query = useQuery({ queryKey: ["shifts"], queryFn: async () => (await api.get("/shifts")).data });
